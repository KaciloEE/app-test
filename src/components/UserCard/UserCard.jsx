...
export const UserCard = ({ user, setUserId, setShowPopup }) => {
    ...
    return (
        <div className='user__card border-2 border-blue-600 rounded my-2 py-4 px-6 bg-transparent'>
            ...
            <div className='flex justify-around items-center mt-4'>
                <button
                    className='text-black px-4 py-2 border border-blue-600 rounded hover:bg-blue-600 transition hover:text-white'
